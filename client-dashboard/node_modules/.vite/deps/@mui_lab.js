...
} from "./chunk-QBOBAESM.js";
import {
  TabPanel_default,
  getTabPanelUtilityClass,
  tabPanelClasses_default
} from "./chunk-OBS7QH36.js";
import {
  TabList_default
} from "./chunk-JSVUQYO3.js";
import {
  TabContext,
  getPanelId,
  getTabId,
  useTabContext
} from "./chunk-CIV5MZFS.js";
import {
  TreeView_default,
  getTreeViewUtilityClass,
  treeViewClasses_default
} from "./chunk-3IV4KF6F.js";
import {
  TreeItem_default,
  getTreeItemUtilityClass,
  treeItemClasses_default,
  useTreeItem
} from "./chunk-5QCWTPYM.js";
import "./chunk-AJGRS5DQ.js";
import {
  useAutocomplete
} from "./chunk-2OVK22GS.js";
import {
  clsx_m_default
...
import "./chunk-IMAGYIAG.js";
import "./chunk-OWHYSTJQ.js";
import "./chunk-MFPPMWQS.js";
import {
  Typography_default
...
import "./chunk-5DA24KXU.js";
import "./chunk-6TCNNOAK.js";
import "./chunk-V747AKGG.js";
import "./chunk-OPA5OKPS.js";
import "./chunk-PR6ZCO7G.js";
import "./chunk-FQDJMOJH.js";
import "./chunk-3FVPF3ZI.js";
import "./chunk-SZGCJHRV.js";
import "./chunk-RB7TUVJJ.js";
import "./chunk-BPNIDY6L.js";
import "./chunk-HJWQ2W6E.js";
import "./chunk-FQMH22SG.js";
import "./chunk-GEI6T3US.js";
import "./chunk-TJ4WWSAQ.js";
import "./chunk-XWW37RNF.js";
import "./chunk-MHEONBTR.js";
import "./chunk-KPCKTKIM.js";
import "./chunk-PX5TE2JW.js";
import "./chunk-MH4W6VPI.js";
import "./chunk-FMFFUJ5P.js";
import "./chunk-R5H4ZAEG.js";
import "./chunk-6YA4AZF5.js";
import "./chunk-CFOEE6DO.js";
import {
  require_react_dom
...
import "./chunk-D2KDPVUT.js";
import "./chunk-JNGTMI72.js";
import "./chunk-3PIBV3LT.js";
import "./chunk-Y6NLWMH7.js";
import "./chunk-3FSLNN6U.js";
import "./chunk-PWX565NS.js";
import "./chunk-5FP35IIW.js";
import "./chunk-5IN5UJN3.js";
import "./chunk-POHHM46I.js";
import {
  capitalize_default
} from "./chunk-FPCAWQ4T.js";
import "./chunk-JD5RR5NZ.js";
import {
  styled_default,
  useThemeProps
...
var TimelineContext = React35.createContext({});
if (true) {
...
var Timeline = React36.forwardRef(function Timeline2(inProps, ref) {
  ...
  return (0, import_jsx_runtime12.jsx)(TimelineContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime12.jsx)(TimelineRoot, _extends({
...
var TimelineConnector = React37.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
  ...
  return (0, import_jsx_runtime13.jsx)(TimelineConnectorRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var TimelineContent = React38.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
  ...
  return (0, import_jsx_runtime14.jsx)(TimelineContentRoot, _extends({
    component: "div",
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
...
var _excluded4 = ["className", "color", "variant"];
...
var TimelineDot = React39.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
  ...
  return (0, import_jsx_runtime15.jsx)(TimelineDotRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
true ? TimelineDot.propTypes = {
   ...
   * @default 'grey'
   */
  color: import_prop_types4.default.oneOfType([import_prop_types4.default.oneOf(["error", "grey", "info", "inherit", "primary", "secondary", "success", "warning"]), import_prop_types4.default.string]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var TimelineOppositeContent = React40.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
  ...
  const {
    position: positionContext
  } = React40.useContext(TimelineContext_default);
  const ownerState = _extends({}, props, {
    position: positionContext || "left"
  });
  const classes = useUtilityClasses5(ownerState);
  return (0, import_jsx_runtime16.jsx)(TimelineOppositeContentRoot, _extends({
    component: "div",
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
...
var _excluded6 = ["position", "className"];
...
var TimelineItem = React41.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  React41.Children.forEach(props.children, (child) => {
  ...
  return (0, import_jsx_runtime17.jsx)(TimelineContext_default.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime17.jsx)(TimelineItemRoot, _extends({
      className: clsx_m_default(classes.root, className),
      ownerState,
      ref
    }, other))
...
var TimelineSeparator = React42.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
  ...
  return (0, import_jsx_runtime18.jsx)(TimelineSeparatorRoot, _extends({
    className: clsx_m_default(classes.root, className),
    ownerState,
    ref
  }, other));
...
var ToggleButton_default2 = React43.forwardRef(function DeprecatedToggleButton(props, ref) {
  if (!warnedOnce35) {
  ...
  return (0, import_jsx_runtime19.jsx)(ToggleButton_default, _extends({
    ref
  }, props));
});
...
var ToggleButtonGroup_default2 = React44.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  if (!warnedOnce36) {
  ...
  return (0, import_jsx_runtime20.jsx)(ToggleButtonGroup_default, _extends({
    ref
  }, props));
});
...
var Masonry = React45.forwardRef(function Masonry2(inProps, ref) {
  ...
  const observer = React45.useRef(typeof ResizeObserver === "undefined" ? void 0 : new ResizeObserver(handleResize));
  React45.useEffect(() => {
  ...
  const lineBreaks = new Array(numberOfLineBreaks).fill("").map((_, index) => (0, import_jsx_runtime21.jsx)("span", {
    "data-class": "line-break",
    style: _extends({}, lineBreakStyle, {
      order: index + 1
    })
  }, index));
  return (0, import_jsx_runtime22.jsxs)(MasonryRoot, _extends({
    as: component,
    className: clsx_m_default(classes.root, className),
    ref: handleRef,
    ownerState
...
true ? Masonry.propTypes = {
   ...
   * @default 4
   */
  columns: import_prop_types8.default.oneOfType([import_prop_types8.default.arrayOf(import_prop_types8.default.oneOfType([import_prop_types8.default.number, import_prop_types8.default.string])), import_prop_types8.default.number, import_prop_types8.default.object, import_prop_types8.default.string]),
  /**
   ...
   */
  defaultColumns: import_prop_types8.default.number,
  /**
   * The default height of the component in px. This is provided for server-side rendering.
   */
  defaultHeight: import_prop_types8.default.number,
  /**
   * The default spacing of the component. Like `spacing`, it is a factor of the theme's spacing. This is provided for server-side rendering.
   */
  defaultSpacing: import_prop_types8.default.number,
  /**
