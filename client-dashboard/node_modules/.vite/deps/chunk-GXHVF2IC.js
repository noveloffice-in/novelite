...
var _excluded3 = ["alt", "children", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"];
...
var Avatar = React8.forwardRef(function Avatar2(inProps, ref) {
  ...
  if (hasImgNotFailing) {
    children = (0, import_jsx_runtime9.jsx)(AvatarImg, _extends({
      alt,
      srcSet,
      src,
      sizes,
...
var _excluded4 = ["children", "className", "component", "componentsProps", "max", "renderSurplus", "slotProps", "spacing", "total", "variant"];
var SPACINGS = {
  small: -16,
  medium: null
};
...
var AvatarGroup = React9.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsxs)(AvatarGroupRoot, _extends({
    ...
    children: [extraAvatars ? (0, import_jsx_runtime10.jsx)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
init_objectWithoutPropertiesLoose();
init_esm();
var _excluded5 = ["boundaryCount", "componentName", "count", "defaultPage", "disabled", "hideNextButton", "hidePrevButton", "onChange", "page", "showFirstButton", "showLastButton", "siblingCount"];
...
var _excluded6 = ["className", "color", "component", "components", "disabled", "page", "selected", "shape", "size", "slots", "type", "variant"];
...
var _excluded7 = ["boundaryCount", "className", "color", "count", "defaultPage", "disabled", "getItemAriaLabel", "hideNextButton", "hidePrevButton", "onChange", "page", "renderItem", "shape", "showFirstButton", "showLastButton", "siblingCount", "size", "variant"];
...
function IconContainer(props) {
  const other = _objectWithoutPropertiesLoose(props, _excluded8);
...
var _excluded9 = ["children", "className", "color", "component", "disabled", "disableFocusRipple", "focusVisibleClassName", "size", "variant"];
...
var SpeedDial = React20.forwardRef(function SpeedDial2(inProps, ref) {
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded10), other = _objectWithoutPropertiesLoose(props, _excluded23);
...
var _excluded11 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var _excluded12 = ["className", "icon", "open", "openIcon"];
...
//# sourceMappingURL=chunk-GXHVF2IC.js.map
