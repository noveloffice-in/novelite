...
var Zs = (n, e, t) => e in n ? Qs(n, e, { enumerable: true, configurable: true, writable: true, value: t }) : n[e] = t;
var xe = (n, e, t) => (Zs(n, typeof e != "symbol" ? e + "" : e, t), t);
var B = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
var zt = {};
var rt = {};
var ft = {};
var fe = B && B.__assign || function() {
...
var wt = B && B.__awaiter || function(n, e, t, r) {
  function s(i) {
...
var Et = B && B.__generator || function(n, e) {
...
var Fe = B && B.__awaiter || function(n, e, t, r) {
  function s(i) {
    return i instanceof t ? i : new t(function(o) {
      o(i);
    });
...
var Ue = B && B.__generator || function(n, e) {
  var t = { label: 0, sent: function() {
    if (i[0] & 1)
      throw i[1];
    return i[1];
  ...
  return n.prototype.getDoc = function(e, t) {
    ...
    return Fe(this, void 0, void 0, function() {
      ...
      return Ue(this, function(b) {
        return s = {}, t && (i = t.fields, o = t.filters, u = t.orFilters, l = t.orderBy, a = t.limit, h = t.limit_start, f = t.groupBy, p = t.asDict, m = p === void 0 ? true : p, g = l ? "".concat(String(l == null ? void 0 : l.field), " ").concat((r = l == null ? void 0 : l.order) !== null && r !== void 0 ? r : "asc") : "", s = {
    ...
    return r === void 0 && (r = false), s === void 0 && (s = false), Fe(this, void 0, void 0, function() {
      var i;
...
var si = B && B.__awaiter || function(n, e, t, r) {
  function s(i) {
    return i instanceof t ? i : new t(function(o) {
      o(i);
    });
...
var ii = B && B.__generator || function(n, e) {
  var t = { label: 0, sent: function() {
    if (i[0] & 1)
      throw i[1];
    return i[1];
...
var ns = function(e, t, r, s, i) {
  return e.config = t, r && (e.code = r), e.request = s, e.response = i, e.isAxiosError = true, e.toJSON = function() {
    return {
  ...
  return Xt = n.isStandardBrowserEnv() ? function() {
    return {
      write: function(r, s, i, o, u, l) {
        var a = [];
        a.push(r + "=" + encodeURIComponent(s)), n.isNumber(i) && a.push("expires=" + new Date(i).toGMTString()), n.isString(o) && a.push("path=" + o), n.isString(u) && a.push("domain=" + u), l === true && a.push("secure"), document.cookie = a.join("; ");
      },
      read: function(r) {
...
function qt() {
  ...
  }, n.prototype.__CANCEL__ = true, rn = n, rn;
}
var sn;
var pr;
function vr() {
  ...
  return sn = function(f) {
    return new Promise(function(m, g) {
      ...
      y.open(f.method.toUpperCase(), r(V, f.params, f.paramsSerializer), true), y.timeout = f.timeout;
      function D() {
        if (!!y) {
...
Vn.transitional = function(e, t, r) {
  ...
  return function(i, o, u) {
    ...
    return t && !wr[o] && (wr[o] = true, console.warn(
      s(
        o,
...
pt.prototype.request = function(e, t) {
  ...
  this.interceptors.request.forEach(function(m) {
    typeof m.runWhen == "function" && m.runWhen(t) === false || (i = i && m.synchronous, s.unshift(m.fulfilled, m.rejected));
  });
  var o = [];
...
function Qi() {
  ...
  return hn = function(t) {
    return n.isObject(t) && t.isAxiosError === true;
  }, hn;
}
var xr = ae;
var Zi = Xr;
...
function so() {
  if (Cr)
    return rt;
  Cr = 1, Object.defineProperty(rt, "__esModule", { value: true }), rt.FrappeApp = void 0;
  var n = hs(), e = ft, t = ht, r = dt, s = Ke, i = function() {
    function o(u, l, a) {
      var h, f;
      this.url = u, this.name = a != null ? a : "FrappeApp", this.useToken = (h = l == null ? void 0 : l.useToken) !== null && h !== void 0 ? h : false, this.token = l == null ? void 0 : l.token, this.tokenType = (f = l == null ? void 0 : l.type) !== null && f !== void 0 ? f : "Bearer", this.axios = (0, s.getAxiosClient)(this.url, this.useToken, this.token, this.tokenType);
    }
...
var Rt = B && B.__awaiter || function(n, e, t, r) {
  function s(i) {
    return i instanceof t ? i : new t(function(o) {
      o(i);
    });
...
var St = B && B.__generator || function(n, e) {
  var t = { label: 0, sent: function() {
    if (i[0] & 1)
      throw i[1];
    return i[1];
...
function hs() {
  return Ar || (Ar = 1, function(n) {
    ...
    Object.defineProperty(n, "__esModule", { value: true }), t(so(), n), t(jt, n), t(ht, n), t(dt, n), t(ft, n);
  }(zt)), zt;
}
var oo = hs();
var ds = { exports: {} };
...
function uo() {
  return kr || (kr = 1, function() {
    ...
    var i = typeof Object.is == "function" ? Object.is : s, o = n.useState, u = n.useEffect, l = n.useLayoutEffect, a = n.useDebugValue, h = false, f = false;
    function p(k, y, M) {
      h || n.startTransition !== void 0 && (h = true, t("You are using an outdated, pre-release alpha of React 18 that does not support useSyncExternalStore. The use-sync-external-store shim will not work correctly. Upgrade to a newer pre-release."));
      var T = y();
      if (!f) {
        var V = y();
        i(T, V) || (t("The result of getSnapshot should be cached to avoid an infinite loop"), f = true);
      }
      var D = o({
        inst: {
          value: T,
...
(function(n) {
  false ? n.exports = ao() : n.exports = uo();
})(ds);
var Ae = () => {
};
var oe = Ae();
...
var Ot = {};
var jn = "undefined";
var $t = typeof window != jn;
var Sn = typeof document != jn;
var fo = () => $t && typeof window.requestAnimationFrame != jn;
var ps = (n, e) => {
  const t = Te.get(n);
  return [
    () => !C(e) && n.get(e) || yn,
...
var Tn = true;
var ho = () => Tn;
var [On, xn] = $t && window.addEventListener ? [
...
var vo = (n) => (Sn && document.addEventListener("visibilitychange", n), On("focus", n), () => {
...
var Lr = !import_react.default.useId;
var lt = !$t || "Deno" in window;
var _o = (n) => fo() ? window.requestAnimationFrame(n) : setTimeout(n, 1);
var mn = lt ? import_react.useEffect : import_react.useLayoutEffect;
var gn = typeof navigator < "u" && navigator.connection;
var Nr = !lt && gn && ([
  "slow-2g",
  "2g"
].includes(gn.effectiveType) || gn.saveData);
var $n = (n) => {
  if (Oe(n))
    try {
      n = n();
...
async function gs(...n) {
  ...
  const a = i.revalidate !== false, h = (m) => typeof u == "function" ? u(m) : u !== false, f = i.throwOnError;
  if (Oe(t)) {
...
var So = (n, e) => ct(n) == ct(e);
var [_s, To] = Eo(/* @__PURE__ */ new Map());
var Oo = De(
  {
    onLoadingSlow: Ae,
    onSuccess: Ae,
...
var Co = (0, import_react.createContext)({});
var Ao = "$inf$";
var bs = $t && window.__SWR_DEVTOOLS_USE__;
var Do = bs ? window.__SWR_DEVTOOLS_USE__ : [];
var ko = () => {
  bs && (window.__SWR_DEVTOOLS_REACT__ = import_react.default);
};
var Lo = (n) => Oe(n[1]) ? [
  n[0],
  n[1],
...
var No = () => De(Oo, (0, import_react.useContext)(Co));
var Po = (n) => (e, t, r) => n(e, t && ((...i) => {
...
ko();
var Br = import_react.default.use || ((n) => {
  if (n.status === "pending")
    throw n;
...
var qo = (n, e, t) => {
  const { cache: r, compare: s, suspense: i, fallbackData: o, revalidateOnMount: u, revalidateIfStale: l, refreshInterval: a, refreshWhenHidden: h, refreshWhenOffline: f, keepPreviousData: p } = t, [m, g, b, E] = Te.get(r), [_, S] = $n(n), k = (0, import_react.useRef)(false), y = (0, import_react.useRef)(false), M = (0, import_react.useRef)(_), T = (0, import_react.useRef)(e), V = (0, import_react.useRef)(t), D = () => V.current, j = () => D().isVisible() && D().isOnline(), [L, Q, ne, G] = ps(r, _), F = (0, import_react.useRef)({}).current, Le = C(o) ? t.fallback[_] : o, Qe = (N, U) => {
    for (const X in F) {
      const I = X;
      if (I === "data") {
    ...
    return true;
  }, Ze = (0, import_react.useMemo)(() => {
    const N = (() => !_ || !e ? false : C(u) ? D().isPaused() || i ? false : C(l) ? true : l : u)(), U = (J) => {
      const de = De(J);
    ...
    r,
    _
  ]), be = ds.exports.useSyncExternalStore((0, import_react.useCallback)(
    (N) => ne(_, (U, X) => {
      Qe(X, U) || N();
    }),
    [
  ...
  ), Ze[0], Ze[1]), et = !k.current, yt = m[_] && m[_].length > 0, we = be.data, Ee = C(we) ? Le : we, Ne = be.error, mt = (0, import_react.useRef)(Ee), Ie = p ? C(we) ? mt.current : we : Ee, Ve = (() => yt && !C(Ne) ? false : et && !C(u) ? u : D().isPaused() ? false : i ? C(Ee) ? false : l : C(Ee) || l)(), je = !!(_ && e && et && Ve), $e = C(be.isValidating) ? je : be.isValidating, tt = C(be.isLoading) ? je : be.isLoading, ve = (0, import_react.useCallback)(
    async (N) => {
      const U = T.current;
      ...
      try {
        if (H && (Q(bt), t.loadingTimeout && C(L().data) && setTimeout(() => {
          ...
          return H && J() && D().onDiscarded(_), false;
        de.error = oe;
        const ie = g[_];
        if (!C(ie) && (I <= ie[0] || I <= ie[1] || ie[1] === 0))
          return _t(), H && J() && D().onDiscarded(_), false;
        const ce = L().data;
        de.data = s(ce, X) ? ce : X, H && J() && D().onSuccess(X, _, t);
      } catch (ie) {
        Me();
        const ce = D(), { shouldRetryOnError: We } = ce;
        ce.isPaused() || (de.error = ie, H && J() && (ce.onError(ie, _, ce), (We === true || Oe(We) && We(ie)) && j() && ce.onErrorRetry(ie, _, ce, (Pe) => {
          const nt = m[_];
      ...
      return re = false, _t(), true;
    },
    [
      _,
      r
    ]
  ), gt = (0, import_react.useCallback)(
    (...N) => gs(r, M.current, ...N),
    []
  );
  if (mn(() => {
    ...
    return y.current = false, M.current = _, k.current = true, Q({
      _k: S
    }), Ve && (C(Ee) || lt ? N() : _o(N)), () => {
      y.current = true, I();
    };
    ...
    f,
    _
  ]), (0, import_react.useDebugValue)(Ie), i && C(Ee) && _) {
    if (!Lr && lt)
      throw new Error("Fallback data is required when using suspense in SSR.");
    T.current = e, V.current = t, y.current = false;
    const N = E[_];
    if (!C(N)) {
      const U = gt(N);
      Br(U);
    ...
    if (C(Ne)) {
      const U = ve(_n);
      C(Ie) || (U.status = "fulfilled", U.value = true), Br(U);
    } else
      throw Ne;
  }
  return {
    mutate: gt,
    get data() {
      return F.data = true, Ie;
    },
    get error() {
      return F.error = true, Ne;
    },
    get isValidating() {
      return F.isValidating = true, $e;
    },
    get isLoading() {
      return F.isLoading = true, tt;
    }
  };
};
var vt = Fo(qo);
...
var ws = typeof Blob == "function" || typeof Blob < "u" && Object.prototype.toString.call(Blob) === "[object BlobConstructor]";
var Es = typeof ArrayBuffer == "function";
var Rs = (n) => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(n) : n && n.buffer instanceof ArrayBuffer;
var Mn = ({ type: n, data: e }, t, r) => ws && e instanceof Blob ? t ? r(e) : Fr(e, r) : Es && (e instanceof ArrayBuffer || Rs(e)) ? t ? r(e) : Fr(new Blob([e]), r) : r(ge[n] + (e || ""));
var Fr = (n, e) => {
...
var ut = typeof Uint8Array > "u" ? [] : new Uint8Array(256);
...
var jo = typeof ArrayBuffer == "function";
var Wn = (n, e) => {
  if (typeof n != "string")
    return {
      type: "message",
...
var he = (() => typeof self < "u" ? self : typeof window < "u" ? window : Function("return this")())();
function xs(n, ...e) {
  return e.reduce((t, r) => (n.hasOwnProperty(r) && (t[r] = n[r]), t), {});
}
var zo = he.setTimeout;
var Ko = he.clearTimeout;
function Mt(n, e) {
...
var Hn = class extends K {
  constructor(e) {
    super(), this.writable = false, Mt(this, e), this.opts = e, this.query = e.query, this.socket = e.socket;
  }
  onError(e, t, r) {
...
var Cs = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-_".split("");
var Dn = 64;
var na = {};
var Ir = 0;
var At = 0;
...
var oa = class extends Hn {
  ...
  onData(e) {
    ...
    Wo(e, this.socket.binaryType).forEach(t), this.readyState !== "closed" && (this.polling = false, this.emitReserved("pollComplete"), this.readyState === "open" && this.poll());
  }
  doClose() {
    const e = () => {
  ...
  uri() {
    ...
    return this.opts.timestampRequests !== false && (t[this.opts.timestampParam] = As()), !this.supportsBinary && !t.sid && (t.b64 = 1), this.createUri(e, t);
  }
  request(e = {}) {
...
var me = class _me extends K {
  ...
  create() {
    ...
    typeof document < "u" && (this.index = _me.requestsCount++, _me.requests[this.index] = this);
  }
  onError(e) {
  ...
  cleanup(e) {
    if (!(typeof this.xhr > "u" || this.xhr === null)) {
      ...
      typeof document < "u" && delete _me.requests[this.index], this.xhr = null;
    }
  }
  onLoad() {
...
var Dt = he.WebSocket || he.MozWebSocket;
var Mr = true;
var aa = "arraybuffer";
var Wr = typeof navigator < "u" && typeof navigator.product == "string" && navigator.product.toLowerCase() === "reactnative";
var ua = class extends Hn {
  constructor(e) {
...
var fa = /^(?:(?![^:@\/?#]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@\/?#]*)(?::([^:@\/?#]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;
var ha = [
  "source",
  "protocol",
  "authority",
...
function kn(n) {
  ...
  for (; o--; )
    i[ha[o]] = s[o] || "";
  return t != -1 && r != -1 && (i.source = e, i.host = i.host.substring(1, i.host.length - 1).replace(/;/g, ":"), i.authority = i.authority.replace("[", "").replace("]", "").replace(/;/g, ":"), i.ipv6uri = true), i.pathNames = da(i, i.path), i.queryKey = pa(i, i.query), i;
}
function da(n, e) {
...
var Ce = class _Ce extends K {
  ...
  open() {
    let e;
    if (this.opts.rememberUpgrade && _Ce.priorWebsocketSuccess && this.transports.indexOf("websocket") !== -1)
      e = "websocket";
  ...
  probe(e) {
    ...
    _Ce.priorWebsocketSuccess = false;
    const s = () => {
        ...
        if (!r)
          if (f.type === "pong" && f.data === "probe") {
            if (this.upgrading = true, this.emitReserved("upgrading", t), !t)
              return;
            _Ce.priorWebsocketSuccess = t.name === "websocket", this.transport.pause(() => {
              r || this.readyState !== "closed" && (h(), this.setTransport(t), t.send([{ type: "upgrade" }]), this.emitReserved("upgrade", t), t = null, this.upgrading = false, this.flush());
            });
          } else {
  ...
  onOpen() {
    if (this.readyState = "open", _Ce.priorWebsocketSuccess = this.transport.name === "websocket", this.emitReserved("open"), this.flush(), this.readyState === "open" && this.opts.upgrade) {
      let e = 0;
  ...
  onError(e) {
    _Ce.priorWebsocketSuccess = false, this.emitReserved("error", e), this.onClose("transport error", e);
  }
  onClose(e, t) {
...
var ya = typeof ArrayBuffer == "function";
var ma = (n) => typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView(n) : n.buffer instanceof ArrayBuffer;
var Ls = Object.prototype.toString;
var ga = typeof Blob == "function" || typeof Blob < "u" && Ls.call(Blob) === "[object BlobConstructor]";
var _a = typeof File == "function" || typeof File < "u" && Ls.call(File) === "[object FileConstructor]";
function Yn(n) {
...
var zn = class _zn extends K {
  ...
  decodeString(e) {
    ...
    if (e.charAt(++t)) {
      ...
      if (_zn.isPayloadValid(r.type, i))
        r.data = i;
      else
...
var Pn = class extends K {
  constructor(e, t) {
    var r;
    super(), this.nsps = {}, this.subs = [], e && typeof e == "object" && (t = e, e = void 0), t = t || {}, t.path = t.path || "/socket.io", this.opts = t, Mt(this, t), this.reconnection(t.reconnection !== false), this.reconnectionAttempts(t.reconnectionAttempts || 1 / 0), this.reconnectionDelay(t.reconnectionDelay || 1e3), this.reconnectionDelayMax(t.reconnectionDelayMax || 5e3), this.randomizationFactor((r = t.randomizationFactor) !== null && r !== void 0 ? r : 0.5), this.backoff = new Xe({
...
function Bt(n, e) {
  ...
  const t = va(n, e.path || "/socket.io"), r = t.source, s = t.id, i = t.path, o = it[s] && i in it[s].nsps, u = e.forceNew || e["force new connection"] || e.multiplex === false || o;
  let l;
...
function Da() {
  return Yr || (Yr = 1, function() {
    ...
    var y = false, M = false, T = false, V = false, D = false, j;
...
` + R[W].replace(" at new ", " at ");
        ...
        tt = false, Ve.current = q, Ie(), Error.prepareStackTrace = A;
      }
    ...
    function Is(c, d) {
      if (typeof c.ref == "string" && Pe.current && d && Pe.current.stateNode !== d) {
        ...
        Wt[v] || (S('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', G(Pe.current.type), c.ref), Wt[v] = true);
      }
    }
    function Vs(c, d) {
      {
        var v = function() {
          Kn || (Kn = true, S("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", d));
        };
        v.isReactWarning = true, Object.defineProperty(c, "key", {
          get: v,
          configurable: true
        });
      }
    ...
    function js(c, d) {
      {
        var v = function() {
          Gn || (Gn = true, S("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", d));
        };
        v.isReactWarning = true, Object.defineProperty(c, "ref", {
          get: v,
          configurable: true
        });
      }
...
Check the top-level render call using <` + v + ">.");
    ...
    function zs(c, d, v) {
      return nr(c, d, v, true);
    }
    function Ks(c, d, v) {
      return nr(c, d, v, false);
    }
    var Gs = Ks, Xs = zs;
...
(function(n) {
  false ? n.exports = Aa() : n.exports = Da();
})(Ps);
var ka = Ps.exports.jsx;
...
var qa = (n) => {
  const {
    ...
    auth: t,
    tokenParams: r
  } = (0, import_react.useContext)(te), [s, i] = (0, import_react.useState)(), o = (0, import_react.useCallback)(() => {
  ...
  const {
    ...
    ...n
  }), p = (0, import_react.useCallback)(async (g, b) => t.loginWithUsernamePassword({
    username: g,
    password: b
  }).then((E) => (o(), E)), []), m = (0, import_react.useCallback)(async () => t.logout().then(() => f(null)).then(() => i(null)), []);
  return {
...
var ja = () => {
  const {
    db: n
  } = (0, import_react.useContext)(te), [e, t] = (0, import_react.useState)(false), [r, s] = (0, import_react.useState)(null), [i, o] = (0, import_react.useState)(false), u = (0, import_react.useCallback)(() => {
    t(false), s(null), o(false);
  }, []);
  return {
    createDoc: (0, import_react.useCallback)(async (a, h) => (s(null), o(false), t(true), n.createDoc(a, h).then((f) => (t(false), o(true), f)).catch((f) => {
      throw t(false), o(false), s(f), f;
    })), []),
    loading: e,
    error: r,
    isCompleted: i,
...
var $a = () => {
  ...
  return {
    updateDoc: (0, import_react.useCallback)(async (a, h, f) => (s(null), o(false), t(true), n.updateDoc(a, h, f).then((p) => (t(false), o(true), p)).catch((p) => {
      throw t(false), o(false), s(p), p;
    })), []),
    loading: e,
    error: r,
    reset: u,
...
var Ma = () => {
  ...
  return {
    deleteDoc: (0, import_react.useCallback)(async (a, h) => (s(null), o(false), t(true), n.deleteDoc(a, h).then((f) => (t(false), o(true), f)).catch((f) => {
      throw t(false), o(false), s(f), f;
    })), []),
    loading: e,
    error: r,
...
var Wa = (n, e, t = false, r = false, s, i) => {
  const {
    url: o,
    db: u
  } = (0, import_react.useContext)(te);
...
var Na = (n, e, t, r) => {
  const {
    call: s
  } = (0, import_react.useContext)(te), i = Fs(e != null ? e : {}), o = `${n}?${i}`;
  return {
...
var Ha = (n) => {
  const {
    call: e
  } = (0, import_react.useContext)(te), [t, r] = (0, import_react.useState)(null), [s, i] = (0, import_react.useState)(false), [o, u] = (0, import_react.useState)(null), [l, a] = (0, import_react.useState)(false), h = (0, import_react.useCallback)(() => {
    r(null), i(false), u(null), a(false);
  }, []);
  return {
    call: (0, import_react.useCallback)(async (p) => (u(null), a(false), i(true), r(null), e.post(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), u(m), m;
    })), []),
    result: t,
    loading: s,
    error: o,
...
var Ja = (n) => {
  ...
  return {
    call: (0, import_react.useCallback)(async (p) => (u(null), a(false), i(true), r(null), e.put(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), u(m), m;
    })), []),
    result: t,
    loading: s,
...
var Ya = (n) => {
  ...
  return {
    call: (0, import_react.useCallback)(async (p) => (u(null), a(false), i(true), r(null), e.delete(n, p).then((m) => (r(m), i(false), a(true), m)).catch((m) => {
      throw i(false), a(false), u(m), m;
    })), []),
    result: t,
    loading: s,
...
var za = () => {
  const {
    file: n
  } = (0, import_react.useContext)(te), [e, t] = (0, import_react.useState)(0), [r, s] = (0, import_react.useState)(false), [i, o] = (0, import_react.useState)(null), [u, l] = (0, import_react.useState)(false), a = (0, import_react.useCallback)(async (f, p, m) => (h(), s(true), n.uploadFile(f, p, (g, b) => t(Math.round(g / b * 100)), m).then((g) => (l(true), t(100), s(false), g.data.message)).catch((g) => {
    throw console.error(g), o(g), s(false), g;
...
var Ga = (n, e, t, r = true) => {
  const {
    socket: s
  } = (0, import_react.useContext)(te), [i, o] = (0, import_react.useState)([]);
  ...
  }, [n, e]), a = (0, import_react.useCallback)((h) => {
