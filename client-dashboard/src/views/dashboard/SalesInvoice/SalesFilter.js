    ...
    return (
        <Box mb={2}>
            <Grid container spacing={3} textAlign="center">
                ...
                <Grid item xs={6} sm={6} lg={3}>
                    <BoxStyled
                        onClick={pendingCount !== 0 ? () => setStatusFilter('Pending') : undefined}
                        sx={{ backgroundColor: 'warning.light', color: 'warning.main', cursor: pendingCount !== 0 ? 'pointer' : 'default' }}
                    >
                ...
                <Grid item xs={6} sm={6} lg={3}>
                    <BoxStyled
                        onClick={creditNoteCount !== 0 ? () => setStatusFilter('Credit Note') : undefined}
                        sx={{ backgroundColor: 'error.light', color: 'error.main', cursor: creditNoteCount !== 0 ? 'pointer' : 'default' }}
                    >
